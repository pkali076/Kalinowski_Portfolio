...
<nav class="navbar has-shadow is-white">
    ...
    <div class="navbar-brand">
        <a target="_blank" href="https://www.adultswim.com/videos/rick-and-morty" class="navbar-item" id="styles">
            <img src="./images/rick.png" alt="link logo" style="max-height: 70px;" class="py-2 px-2">
        </a>
    ...
    <div class="navbar-menu current-page" id="nav-links">
        <div class="navbar-start" id="tabcontent"> 
            <a class="navbar-item current-state" href="about.html" id="styles">Home</a>
            <a class="navbar-item" href="app.html" id="styles">App</a>
            <a class="navbar-item" href="favorites.html" id="styles">Favorites</a>
            <!-- <a class="navbar-item" href="community.html" id="styles">Community</a> -->
            <a class="navbar-item" href="documentation.html" id="styles">Documentation</a>
        </div>
    </div>
</nav>
